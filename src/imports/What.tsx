...
function GroupGlassEffect() {
  return (
    <div className="absolute content-stretch flex h-[381px] items-start left-[-21px] pl-0 pr-[5px] py-0 rounded-[24px] top-[calc(50%-0.5px)] translate-y-[-50%] w-[951px]" data-name="Glass effect 2">
      <div className="basis-0 grow h-full min-h-px min-w-px mr-[-5px] relative rounded-[24px] shrink-0" data-name="Base">
...
export default function What() {
  return (
    <div className="bg-[#111] relative w-full min-h-screen responsive-what" data-name="What">
      <div
        className="what-logo absolute md:relative h-[54px] md:h-auto left-[86px] md:left-auto top-[96px] md:top-auto w-[141px] md:w-auto md:mb-4 md:ml-4"
      ...
      <div className="what-navbar">
        <NavBar />
      </div>
      <div className="what-content">
        <LinkLetsTalk />
        <Frame6 />
        <div className="what-title absolute md:relative flex flex-col font-['Poppins:Regular',sans-serif] h-[139px] md:h-auto justify-center leading-[0] md:leading-normal left-[calc(50%-233px)] md:left-auto not-italic text-[42px] md:text-[28px] text-white top-[884.5px] md:top-auto tracking-[-3px] md:tracking-normal translate-y-[-50%] md:translate-y-0 w-[465px] md:w-full md:px-4 md:py-4">
          <p className="leading-[65px] md:leading-[1.4]">
            <span>{`Our core `}</span>
            <span className="font-['Poppins:Bold_Italic',sans-serif] italic">
              competencies
            </span>
        ...
        <div className="what-subtitle absolute md:relative flex flex-col font-['Manrope:Regular',sans-serif] font-normal h-[74px] md:h-auto justify-center leading-[0] md:leading-normal left-[492px] md:left-auto text-[18px] md:text-[16px] text-white top-[963px] md:top-auto translate-y-[-50%] md:translate-y-0 w-[418px] md:w-full md:px-4 md:pb-4">
          <p className="leading-[31px] md:leading-[1.5]">
